...
describe('Blog Generator', () => {
  ...
  test('should contain a toy component for a post', () => {
    ...
    const html = generateBlog({ blog, header, footer }, wrapHtml);
    const expectedHtml = `<html><body><article class="entry" id="TOY01"><div class="key full-width">▄▄▄▄▄▄▄▄▄▄</div><div class="value full-width">▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄</div><div class="key article-title">TOY01</div><div class="value"><h2><a href="#TOY01">Post with Toy</a></h2></div><div class="key">pubAt</div><p class="value metadata">1 Mar 2024</p><div class="key">in</div><div class="value"><select class="input"><option value="text">text</option><option value="textarea">textarea</option><option value="file">file</option><option value="number">number</option><option value="kv">kv</option><option value="blog-key">blog-key</option><option value="dendrite-story">dendrite-story</option><option value="dendrite-page">dendrite-page</option><option value="moderator-ratings">moderator-ratings</option><option value="keyboard-capture">keyboard-capture</option><option value="gamepad-capture">gamepad-capture</option><option value="gamepad-button-mapper">gamepad-button-mapper</option></select><input type="text" disabled></div><div class="key"></div><div class="value"><button type="submit" disabled>Submit</button><label class="auto-submit-label"><input type="checkbox" class="auto-submit-checkbox" disabled /> Auto</label></div><div class="key">out</div><div class="value"><select class="output"><option value="text">text</option><option value="pre">pre</option><option value="copy-to-clipboard">copy-to-clipboard</option><option value="ledger-ingest">ledger-ingest</option><option value="joycon-mapping">joycon-mapping</option><option value="tic-tac-toe">tic-tac-toe</option><option value="battleship-solitaire-fleet">battleship-solitaire-fleet</option><option value="battleship-solitaire-clues-presenter">battleship-solitaire-clues-presenter</option></select><div class="output warning"><p>This toy requires Javascript to run.</p></div></div><script type="module">window.addComponent('TOY01', './toys/2024-03-01/calculator.js', 'calculator');</script></article><article class="entry" id="LINK1"><div class="key full-width">▄▄▄▄▄▄▄▄▄▄</div><div class="value full-width">▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄</div><div class="key article-title">LINK1</div><div class="value"><h2><a href="#LINK1">Post with Related Links</a></h2></div><div class="key">pubAt</div><p class="value metadata">2 Mar 2024</p><div class="key">in</div><div class="value"><select class="input"><option value="text">text</option><option value="textarea">textarea</option><option value="file">file</option><option value="number">number</option><option value="kv">kv</option><option value="blog-key">blog-key</option><option value="dendrite-story">dendrite-story</option><option value="dendrite-page">dendrite-page</option><option value="moderator-ratings">moderator-ratings</option><option value="keyboard-capture">keyboard-capture</option><option value="gamepad-capture">gamepad-capture</option><option value="gamepad-button-mapper">gamepad-button-mapper</option></select><input type="text" disabled></div><div class="key"></div><div class="value"><button type="submit" disabled>Submit</button><label class="auto-submit-label"><input type="checkbox" class="auto-submit-checkbox" disabled /> Auto</label></div><div class="key">out</div><div class="value"><select class="output"><option value="text">text</option><option value="pre">pre</option><option value="copy-to-clipboard">copy-to-clipboard</option><option value="ledger-ingest">ledger-ingest</option><option value="joycon-mapping">joycon-mapping</option><option value="tic-tac-toe">tic-tac-toe</option><option value="battleship-solitaire-fleet">battleship-solitaire-fleet</option><option value="battleship-solitaire-clues-presenter">battleship-solitaire-clues-presenter</option></select><div class="output warning"><p>This toy requires Javascript to run.</p></div></div><div class="key">links</div><div class="value"><ul class="related-links"><li><a href="https://example.com/article" target="_blank" rel="noopener">"Example Article"</a> by John Doe, Example Blog</li><li><a href="https://example.org/book" target="_blank" rel="noopener"><em>_Programming Guide_</em></a> by Jane Smith, Tech Publishing</li></ul></div><script type="module">window.addComponent('LINK1', './toys/2024-03-02/counter.js', 'counter');</script></article></body></html>`;
    expect(html).toBe(expectedHtml);
  });
