...
describe('Blog Generator', () => {
  test('should generate complete HTML page with multiple posts', () => {
    ...
    const expectedHtml = `<html><body><article class="entry" id="SECO2"><div class="key full-width">▄▄▄▄▄▄▄▄▄▄</div><div class="value full-width">▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄</div><div class="key article-title">SECO2</div><div class="value"><h2><a href="#SECO2">Second Post</a></h2></div><div class="key">pubAt</div><p class="value metadata">5 May 2022</p><div class="key media">illus</div><div class="value"><img loading="lazy" src="foo.png" alt="a tangle of yellow and black woollen yarn"/></div><div class="key media">audio</div><audio class="value" controls><source src="2022-05-05.m4a"></audio><div class="key media">video</div><p class="value"><iframe height="300px" width="100%" src="https://www.youtube.com/embed/EdlrqPPI_YQ?start=420" title="Lonely &amp; Horny Episode 2 - Orion" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" loading="lazy" allowfullscreen></iframe></p><div class="key">text</div><p class="value">Second post content</p><div class="key"></div><p class="value">Another paragraph</p><div class="key">in</div><div class="value"><select class="input"><option value="text">text</option><option value="textarea">textarea</option><option value="life-seed">life-seed</option><option value="file">file</option><option value="number">number</option><option value="real-hourly-wage">real-hourly-wage</option><option value="kv">kv</option><option value="blog-key">blog-key</option><option value="dendrite-story">dendrite-story</option><option value="dendrite-page">dendrite-page</option><option value="moderator-ratings">moderator-ratings</option><option value="keyboard-capture">keyboard-capture</option><option value="gamepad-capture">gamepad-capture</option><option value="gamepad-button-mapper">gamepad-button-mapper</option></select><input type="text" disabled></div><div class="key"></div><div class="value"><button type="button" class="toy-focus-toggle">Focus mode</button><button type="submit" disabled>Submit</button><label class="auto-submit-label"><input type="checkbox" class="auto-submit-checkbox" disabled /> Auto</label></div><div class="key">out</div><div class="value"><select class="output"><option value="text">text</option><option value="pre">pre</option><option value="copy-to-clipboard">copy-to-clipboard</option><option value="canvas-2d">canvas-2d</option><option value="graph-2d">graph-2d</option><option value="ledger-ingest">ledger-ingest</option><option value="real-hourly-wage">real-hourly-wage</option><option value="joycon-mapping">joycon-mapping</option><option value="realtime-voice">realtime-voice</option><option value="tic-tac-toe">tic-tac-toe</option><option value="battleship-solitaire-fleet">battleship-solitaire-fleet</option><option value="battleship-solitaire-clues-presenter">battleship-solitaire-clues-presenter</option></select><div class="output warning"><p>This toy requires Javascript to run.</p></div></div><div class="key">links</div><div class="value"><ul class="related-links"><li><a href="https://example.com/video-tutorial" target="_blank" rel="noopener">Video Tutorial</a> by John Smith, Example Videos</li><li><a href="https://example.org/report-2022" target="_blank" rel="noopener">"Annual Report 2022"</a> by Research Team, Example Organization ("Significant progress was made in all key areas")</li><li><a href="https://example.net" target="_blank" rel="noopener">Example Website</a>, Example Net</li></ul></div><script type="module">window.addComponent('SECO2', '/toys/2025-03-19/identity.js', 'identity');</script></article><article class="entry" id="FIRS1"><div class="key full-width">▄▄▄▄▄▄▄▄▄▄</div><div class="value full-width">▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄</div><div class="key article-title">FIRS1</div><div class="value"><h2><a href="#FIRS1">First Post</a></h2></div><div class="key">pubAt</div><p class="value metadata">4 May 2022</p><div class="key media">illus</div><div class="value"><img loading="lazy" src="2022-05-04.png" alt="a messy desk, digital art, black and white"/></div><div class="key media">audio</div><audio class="value" controls><source src="2022-05-04.mp3"></audio><div class="key">text</div><p class="value">First post content</p><div class="key">links</div><div class="value"><ul class="related-links"><li><a href="https://en.wikipedia.org/wiki/Blog" target="_blank" rel="noopener">"Blog"</a> by Wikipedia, Wikipedia (EN)</li><li><a href="https://twitter.com/example/status/123456789" target="_blank" rel="noopener">"Thoughts on blogging"</a> by @exampleuser</li><li><a href="https://example.com/books/blogging-101" target="_blank" rel="noopener"><em>_Blogging 101_</em></a> by Jane Doe, Example Publishing ("Blogging is an essential skill for the digital age")</li></ul></div></article></body></html>`;
  ...
  test('should contain a toy component for a post', () => {
    ...
    const html = generateBlog({ blog, header, footer }, wrapHtml);
    const expectedHtml = `<html><body><article class="entry" id="LINK1"><div class="key full-width">▄▄▄▄▄▄▄▄▄▄</div><div class="value full-width">▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄</div><div class="key article-title">LINK1</div><div class="value"><h2><a href="#LINK1">Post with Related Links</a></h2></div><div class="key">pubAt</div><p class="value metadata">2 Mar 2024</p><div class="key">in</div><div class="value"><select class="input"><option value="text">text</option><option value="textarea">textarea</option><option value="life-seed">life-seed</option><option value="file">file</option><option value="number">number</option><option value="real-hourly-wage">real-hourly-wage</option><option value="kv">kv</option><option value="blog-key">blog-key</option><option value="dendrite-story">dendrite-story</option><option value="dendrite-page">dendrite-page</option><option value="moderator-ratings">moderator-ratings</option><option value="keyboard-capture">keyboard-capture</option><option value="gamepad-capture">gamepad-capture</option><option value="gamepad-button-mapper">gamepad-button-mapper</option></select><input type="text" disabled></div><div class="key"></div><div class="value"><button type="button" class="toy-focus-toggle">Focus mode</button><button type="submit" disabled>Submit</button><label class="auto-submit-label"><input type="checkbox" class="auto-submit-checkbox" disabled /> Auto</label></div><div class="key">out</div><div class="value"><select class="output"><option value="text">text</option><option value="pre">pre</option><option value="copy-to-clipboard">copy-to-clipboard</option><option value="canvas-2d">canvas-2d</option><option value="graph-2d">graph-2d</option><option value="ledger-ingest">ledger-ingest</option><option value="real-hourly-wage">real-hourly-wage</option><option value="joycon-mapping">joycon-mapping</option><option value="realtime-voice">realtime-voice</option><option value="tic-tac-toe">tic-tac-toe</option><option value="battleship-solitaire-fleet">battleship-solitaire-fleet</option><option value="battleship-solitaire-clues-presenter">battleship-solitaire-clues-presenter</option></select><div class="output warning"><p>This toy requires Javascript to run.</p></div></div><div class="key">links</div><div class="value"><ul class="related-links"><li><a href="https://example.com/article" target="_blank" rel="noopener">"Example Article"</a> by John Doe, Example Blog</li><li><a href="https://example.org/book" target="_blank" rel="noopener"><em>_Programming Guide_</em></a> by Jane Smith, Tech Publishing</li></ul></div><script type="module">window.addComponent('LINK1', './toys/2024-03-02/counter.js', 'counter');</script></article><article class="entry" id="TOY01"><div class="key full-width">▄▄▄▄▄▄▄▄▄▄</div><div class="value full-width">▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄</div><div class="key article-title">TOY01</div><div class="value"><h2><a href="#TOY01">Post with Toy</a></h2></div><div class="key">pubAt</div><p class="value metadata">1 Mar 2024</p><div class="key">in</div><div class="value"><select class="input"><option value="text">text</option><option value="textarea">textarea</option><option value="life-seed">life-seed</option><option value="file">file</option><option value="number">number</option><option value="real-hourly-wage">real-hourly-wage</option><option value="kv">kv</option><option value="blog-key">blog-key</option><option value="dendrite-story">dendrite-story</option><option value="dendrite-page">dendrite-page</option><option value="moderator-ratings">moderator-ratings</option><option value="keyboard-capture">keyboard-capture</option><option value="gamepad-capture">gamepad-capture</option><option value="gamepad-button-mapper">gamepad-button-mapper</option></select><input type="text" disabled></div><div class="key"></div><div class="value"><button type="button" class="toy-focus-toggle">Focus mode</button><button type="submit" disabled>Submit</button><label class="auto-submit-label"><input type="checkbox" class="auto-submit-checkbox" disabled /> Auto</label></div><div class="key">out</div><div class="value"><select class="output"><option value="text">text</option><option value="pre">pre</option><option value="copy-to-clipboard">copy-to-clipboard</option><option value="canvas-2d">canvas-2d</option><option value="graph-2d">graph-2d</option><option value="ledger-ingest">ledger-ingest</option><option value="real-hourly-wage">real-hourly-wage</option><option value="joycon-mapping">joycon-mapping</option><option value="realtime-voice">realtime-voice</option><option value="tic-tac-toe">tic-tac-toe</option><option value="battleship-solitaire-fleet">battleship-solitaire-fleet</option><option value="battleship-solitaire-clues-presenter">battleship-solitaire-clues-presenter</option></select><div class="output warning"><p>This toy requires Javascript to run.</p></div></div><script type="module">window.addComponent('TOY01', './toys/2024-03-01/calculator.js', 'calculator');</script></article></body></html>`;
    expect(html).toBe(expectedHtml);
  });
  ...
  test('should display tags for posts', () => {
    ...
    const html = generateBlog({ blog, header, footer }, wrapHtml);
    const expectedHtml = `<html><body><article class="entry tag-javascript tag-programming tag-web-development" id="TAG02"><div class="key full-width">▄▄▄▄▄▄▄▄▄▄</div><div class="value full-width">▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄</div><div class="key article-title">TAG02</div><div class="value"><h2><a href="#TAG02">Post with Multiple Tags</a></h2></div><div class="key">pubAt</div><p class="value metadata">2 Apr 2024</p><div class="key">tags</div><p class="value metadata"><a class="tag-javascript">javascript</a>, <a class="tag-programming">programming</a>, <a class="tag-web-development">web-development</a></p><div class="key">text</div><p class="value">This is a post with multiple tags.</p></article><article class="entry tag-tutorial" id="TAG01"><div class="key full-width">▄▄▄▄▄▄▄▄▄▄</div><div class="value full-width">▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄</div><div class="key article-title">TAG01</div><div class="value"><h2><a href="#TAG01">Post with Single Tag</a></h2></div><div class="key">pubAt</div><p class="value metadata">1 Apr 2024</p><div class="key">tags</div><p class="value metadata"><a class="tag-tutorial">tutorial</a></p><div class="key">text</div><p class="value">This is a post with a single tag.</p></article></body></html>`;
    expect(html).toBe(expectedHtml);
  });
