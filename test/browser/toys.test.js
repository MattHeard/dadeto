...
describe('toggleToyFocusMode', () => {
  it('toggles the toy article class and button label', () => {
    ...
    article.classList.contains = article.classList.has.bind(article.classList);
    article.classList.add = article.classList.add.bind(article.classList);
    article.classList.remove = article.classList.delete.bind(article.classList);
    const button = {
    ...
    container.classList.add = container.classList.add.bind(container.classList);
    ...
    expect(dom.addClass).toHaveBeenCalledWith(container, 'toy-focus-mode-host');
