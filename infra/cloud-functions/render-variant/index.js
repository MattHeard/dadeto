...
function buildHtml(content, options) {
  ...
  return `<!doctype html><html lang="en"><head><meta charset="UTF-8" /><title>Dendrite</title><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@picocss/pico@2/css/pico.fluid.classless.min.css" /></head><body><h1>Dendrite</h1><p>${escapeHtml(
    content
...
function buildAltsHtml(pageNumber, variants) {
  const items = variants
    ...
    .join('');
  return `<!doctype html><html lang="en"><head><meta charset="UTF-8" /><title>Dendrite</title><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@picocss/pico@2/css/pico.fluid.classless.min.css" /></head><body><h1><a href="/">Dendrite</a></h1><ol>${items}</ol></body></html>`;
}
