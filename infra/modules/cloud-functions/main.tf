...
data "archive_file" "get_api_key_src" {
  ...
  output_path = "${path.root}/build/get-api-key-credit.zip"
}
...
data "archive_file" "submit_src" {
  ...
  output_path = "${path.root}/build/submit-new-story.zip"
}

data "archive_file" "submit_page_src" {
  type        = "zip"
  source_dir  = "${path.root}/cloud-functions/submit-new-page"
  output_path = "${path.root}/build/submit-new-page.zip"
}
...
data "archive_file" "assign_moderation_job_src" {
  ...
  output_path = "${path.root}/build/assign-moderation-job.zip"
}
...
data "archive_file" "get_moderation_variant_src" {
  ...
  output_path = "${path.root}/build/get-moderation-variant.zip"
}
...
data "archive_file" "submit_moderation_rating_src" {
  type        = "zip"
  source_dir  = "${path.root}/cloud-functions/submit-moderation-rating"
  output_path = "${path.root}/build/submit-moderation-rating.zip"
}
...
data "archive_file" "report_for_moderation_src" {
  type        = "zip"
  source_dir  = "${path.root}/cloud-functions/report-for-moderation"
  output_path = "${path.root}/build/report-for-moderation.zip"
}
...
data "archive_file" "process_src" {
  type        = "zip"
  source_dir  = "${path.root}/cloud-functions/process-new-story"
  output_path = "${path.root}/build/process-new-story.zip"
}
...
data "archive_file" "prod_update_variant_visibility_src" {
  ...
  output_path = "${path.root}/build/prod-update-variant-visibility.zip"
}
...
data "archive_file" "process_page_src" {
  ...
  output_path = "${path.root}/build/process-new-page.zip"
}
...
data "archive_file" "render_variant_src" {
  ...
  output_path = "${path.root}/build/render-variant.zip"
}
...
data "archive_file" "hide_variant_html_src" {
  ...
  output_path = "${path.root}/build/hide-variant-html.zip"
}
...
data "archive_file" "mark_variant_dirty_src" {
  ...
  output_path = "${path.root}/build/mark-variant-dirty.zip"
}
...
data "archive_file" "generate_stats_src" {
  ...
  output_path = "${path.root}/build/generate-stats.zip"
}
...
data "archive_file" "render_contents_src" {
  ...
  output_path = "${path.root}/build/render-contents.zip"
}
...
data "archive_file" "get_api_key_credit_v2_src" {
  type        = "zip"
  source_dir  = "${path.root}/cloud-functions/get-api-key-credit-v2"
  output_path = "${path.root}/build/get-api-key-credit-v2.zip"
}
