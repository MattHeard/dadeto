# Delivery Outbound Segment Proposal

## What this toy does

Delivery Outbound Segment Proposal is a focused toy for exercising one small domain behavior. Use it to inspect the behavior described in the toy's documented behavior without needing to understand the surrounding application.
