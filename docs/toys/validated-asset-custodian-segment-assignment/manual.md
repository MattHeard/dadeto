# VALI3 — Validated Asset Custodian Segment Assignment

## What this toy does

Explore VALI3 — Validated Asset Custodian Segment Assignment with deterministic input and output.
...
- `(see the JSON object described by the toy)`
