# Object Minute Asset Registry

## What this toy does

Object Minute Asset Registry is a focused toy for exercising one small domain behavior. Use it to inspect the behavior described in the toy's documented behavior without needing to understand the surrounding application.
