# Runner Shift Segment Feasibility

## What this toy does

Runner Shift Segment Feasibility is a focused toy for exercising one small domain behavior. Use it to inspect the behavior described in the toy's documented behavior without needing to understand the surrounding application.
