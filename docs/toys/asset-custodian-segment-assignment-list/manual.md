# Asset Custodian Segment Assignment List

## What this toy does

Asset Custodian Segment Assignment List is a focused toy for exercising one small domain behavior. Use it to inspect the behavior described in the toy's documented behavior without needing to understand the surrounding application.
