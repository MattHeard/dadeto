...
- Error signatures/log lines:
  ...
  - Missing `BEAC1` entry in the blog data.
- Observable symptoms:
...
- Failing command(s):
  - `node --experimental-vm-modules ./node_modules/.bin/jest --watchman=false --runTestsByPath test/toys/2026-07-01/beaconBounce.test.js`
  - `npm run build`
...
- Root cause: n/a
- Fix implemented: n/a
- Guardrail added (test/doc/harness): Beacon Bounce toy docs and focused Jest coverage
