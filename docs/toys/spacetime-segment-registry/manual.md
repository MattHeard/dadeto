...
Spacetime Segment Registry is a focused toy for exercising one small domain behavior. Use it to inspect the behavior described in [spec.md](spec.md) without needing to understand the surrounding application.
