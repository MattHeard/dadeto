...
In scope: temporary, permanent, and envelope memory; dot paths; JSON object append. Out of scope: deduplication, removal, querying, transactions, and schema validation.
