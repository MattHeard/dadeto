# Assign Asset And Custodian To Segment If Feasible

## What this toy does

Assign Asset And Custodian To Segment If Feasible is a focused toy for exercising one small domain behavior. Use it to inspect the behavior described in the toy's documented behavior without needing to understand the surrounding application.
