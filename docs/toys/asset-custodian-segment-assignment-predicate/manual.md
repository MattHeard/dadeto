...
Asset Custodian Segment Assignment Predicate is a focused toy for exercising one small domain behavior. Use it to explore this focused behavior directly in the toy interface.
