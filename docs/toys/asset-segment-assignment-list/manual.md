...
In scope: validate `assetId` and `segmentId`, then append the pair to a selected memory list. Out of scope: updates, removal, deduplication, lookups, and feasibility.
