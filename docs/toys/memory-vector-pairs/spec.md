...
- This version extends the original Memory Vector toy by turning object values into vectors of `{ key, value }` pairs.
...
- In scope:
  ...
  - Convert object values into vectors of key-value pairs.
...
- Internal dependencies:
  ...
  - `src/build/blog.json`
  - `test/toys/2026-05-28/memoryVectorPairs.test.js`
