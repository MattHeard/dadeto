...
- Diagnosis path: focused Jest passed, the beta build copied the generated `OBJE1` entry, and the escalated check was rerun with `DADETO_COVERAGE_SHARD_SIZE=1000`.
