...
The lines 1840-1901 wrapper-handle tail scan found 2 static-ignored mutants and 0 non-static survivors across 63 tests. A broad authoritative full-file attempt instrumented 540 mutants but was stopped after 8 processed mutants with 4 mutation-induced timeouts and an impractical multi-hour ETA; it is not treated as completion evidence. The bounded executable ranges cover the module, but a fast full-file verifier or harness is still needed before counting `toys.js` complete.
