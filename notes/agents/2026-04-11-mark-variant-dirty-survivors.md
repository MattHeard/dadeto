# mark-variant-dirty surviving mutants

- [x] `Neon Switch` - mutant `78` at `src/core/cloud/mark-variant-dirty/mark-variant-dirty-core.js:453` (applied, not re-verified)
- [ ] `Chrome Veil` - mutant `86` at `src/core/cloud/mark-variant-dirty/mark-variant-dirty-core.js:465`
