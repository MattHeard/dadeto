...
- **Action:** Removed the optional message arguments, dropped the validation guard clauses for `verifyToken`, `isAdminUid`, and the response helpers, and updated the tests to reflect the streamlined middleware contract.
