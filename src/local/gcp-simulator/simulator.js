...
import { createProcessNewStoryHandler } from '../../core/cloud/process-new-story/process-new-story-core.js';
import { createProcessNewPageHandler } from '../../core/cloud/process-new-page/process-new-page-core.js';
import { createHandleSubmit, parseIncomingOption } from '../../core/cloud/submit-new-page/submit-new-page-core.js';
import { createRenderContents } from '../../core/cloud/render-contents/render-contents-core.js';
import {
  createRenderVariant,
  createHandleVariantWrite,
} from '../../core/cloud/render-variant/render-variant-core.js';
import { createGenerateStatsCore } from '../../core/cloud/generate-stats/generate-stats-core.js';
import { createSubmitNewStoryResponder } from '../../core/cloud/submit-new-story/submit-new-story-core.js';
import { getAuthorizationHeader } from '../../core/cloud/submit-shared.js';
