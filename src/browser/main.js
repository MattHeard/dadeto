...
const createHandleSubmit = (inputElement, outputElement, globalState, processingFunction, stopDefault) => (event) => {
  if (event) {
    stopDefault(event);
  }
 ...
 */
function initializeInteractiveComponent(article, processingFunction, querySelector, globalState) {
  ...
  const handleSubmit = createHandleSubmit(inputElement, outputElement, globalState, processingFunction, stopDefault);
    ...
    entries.forEach(entry => {
      ...
      if (entry.isIntersecting) {
        ...
        import(modulePath).then((module) => {
          ...
          initializeInteractiveComponent(article, processingFunction, querySelector, globalState);
        }).catch(error => {
