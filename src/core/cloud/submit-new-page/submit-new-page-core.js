...
/** @typedef {{ express: Function, cors: Function, allowedOrigins: string[], handleSubmit: Function }} SubmitNewPageAppDeps */
 ...
 * @param {SubmitNewPageAppDeps} deps Dependencies for app wiring.
