...
/**
 * Create the navbar wrapper handle.
 * @returns {{ createNavbar: typeof createNavbar, createLinksBar: typeof createLinksBar }}
 *   Navbar exports.
 */
export function createNavbarHandle() {
  return { createNavbar, createLinksBar };
}
