 ...
 * @param {{from: RegExp, to: string}} replacement The replacement definition.
 ...
 * @param {string} text The text to process.
 * @param {Array<{from: RegExp, to: string}>} replacements Replacement definitions.
 ...
 * @returns {Record<string, (...args: never[]) => unknown>} HTML helper handle.
 */
