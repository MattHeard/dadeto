...
/**
 * Create the copy-cloud wrapper handle.
 * @returns {() => void} Entry handle; copy work runs when this module loads.
 */
export function createCopyCloudHandle() {
  return function handleCopyCloud() {};
}
