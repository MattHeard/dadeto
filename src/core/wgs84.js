 ...
 */
function calculateWgs84SurfaceDistance(lat1, lon1, lat2, lon2) {
  const latitude1 = Number(lat1),
    longitude1 = Number(lon1),
    latitude2 = Number(lat2),
    longitude2 = Number(lon2);
  ...
  for (let i = 0; i < 100; i++) {
    ...
    lambda = next;
    if (i === 99)
      return spherical(latitude1, longitude1, latitude2, longitude2);
  }
  // Stryker restore all
