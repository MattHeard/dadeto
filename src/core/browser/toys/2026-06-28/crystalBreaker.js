...
export const crystalBreakerTestOnly = {
  ...
  normalizeSeedHeight,
  normalizeSeedLives,
  normalizeSeedPaddleWidth,
  normalizeSeedPaddleHeight,
  normalizeSeedPaddleSpeed,
  normalizeSeedOrbRadius,
  normalizeSeedLayoutSeed,
  ...
  getCrystalHp,
  getCrystalRowOffset,
  normalizeCrystalsFromState,
  normalizeCrystalFromState,
  normalizeCrystalPositionAndSize,
  normalizeCrystalStats,
  getCrystalId,
  normalizeCrystalState,
  parseActions,
  buildNextKeyboardState,
  buildActionState,
  isMoveLeftPressed,
  isMoveRightPressed,
  updateInputState,
