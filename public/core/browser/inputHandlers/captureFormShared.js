 ...
 * @param {(context: { dom: DOMHelpers, form: HTMLElement, button: HTMLButtonElement, cleanupFns: CleanupFn[] }) => void} onFormReady - Handler-specific wiring that runs after the form is created.
